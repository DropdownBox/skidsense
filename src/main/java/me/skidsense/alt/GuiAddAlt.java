...
extends GuiScreen {
    ...
    public void drawScreen(int i, int j, float f) {
        ...
        Client.mc.fontRendererObj.drawCenteredString("Add Alt", this.width / 2, 20, -1);
        this.username.drawTextBox();
        this.password.drawTextBox();
        this.combined.drawTextBox();
        if (this.username.getText().isEmpty()) {
            Client.mc.fontRendererObj.drawStringWithShadow("Username / E-Mail", this.width / 2 - 96, 66.0f, -7829368);
        }
        if (this.password.getText().isEmpty()) {
            Client.mc.fontRendererObj.drawStringWithShadow("Password", this.width / 2 - 96, 106.0f, -7829368);
        }
        if (this.combined.getText().isEmpty()) {
            Client.mc.fontRendererObj.drawStringWithShadow("Email:Password", this.width / 2 - 96, 146.0f, -7829368);
        }
        Client.mc.fontRendererObj.drawCenteredString(this.status, this.width / 2, 30, -1);
    ...
    public static void access$0(GuiAddAlt guiAddAlt, String string) {
