...
extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        Client.mc.fontRendererObj.drawCenteredString("Alt Login", this.width / 2, 20, -1);
        Client.mc.fontRendererObj.drawCenteredString(this.thread == null ? "\u00a7eWaiting..." : this.thread.getStatus(), this.width / 2, 29, -1);
