...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        Client.mc.fontRendererObj.drawCenteredString("Edit Alt", this.width / 2, 10, -1);
        Client.mc.fontRendererObj.drawCenteredString(this.status, this.width / 2, 20, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            Client.mc.fontRendererObj.drawStringWithShadow("New E-Mail", this.width / 2 - 96, 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            Client.mc.fontRendererObj.drawStringWithShadow("New Password", this.width / 2 - 96, 106.0f, -7829368);
        }
