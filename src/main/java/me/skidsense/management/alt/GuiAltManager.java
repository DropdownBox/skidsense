...
public class GuiAltManager extends GuiScreen {
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      //RenderUtil.rectangle(0.0D, 0.0D, (double)this.width, (double)this.height, Colors.getColor(0, 255));
      if (Mouse.hasWheel()) {
      ...
      while(true) {
         ...
         if (alt != this.selectedAlt) {
            if (this.isMouseOverAlt(par1, par2, y - this.offset) && Mouse.isButtonDown(0)) {
               RenderUtil.rectangleBordered(52.0D, (double)(y - this.offset - 4), (double)(this.width - 52), (double)(y - this.offset + 20), 1.0D, -Colors.getColor(145, 50), -2146101995);
            } else if (this.isMouseOverAlt(par1, par2, y - this.offset)) {
               RenderUtil.rectangleBordered(52.0D, (double)(y - this.offset - 4), (double)(this.width - 52), (double)(y - this.offset + 20), 1.0D, Colors.getColor(145, 50), -2145180893);
            }
         } else {
            if (this.isMouseOverAlt(par1, par2, y - this.offset) && Mouse.isButtonDown(0)) {
               RenderUtil.rectangleBordered(52.0D, (double)(y - this.offset - 4), (double)(this.width - 77), (double)(y - this.offset + 20), 1.0D, Colors.getColor(145, 50), -2142943931);
            } else if (this.isMouseOverAlt(par1, par2, y - this.offset)) {
               RenderUtil.rectangleBordered(52.0D, (double)(y - this.offset - 4), (double)(this.width - 77), (double)(y - this.offset + 20), 1.0D, Colors.getColor(145, 50), -2142088622);
            } else {
               RenderUtil.rectangleBordered(52.0D, (double)(y - this.offset - 4), (double)(this.width - 77), (double)(y - this.offset + 20), 1.0D, Colors.getColor(145, 50), -2144259791);
            }

            boolean hovering = par1 >= this.width - 76 && par1 <= this.width - 52 && par2 >= y - this.offset - 4 && par2 <= y - this.offset + 20;
            RenderUtil.rectangleBordered((double)(this.width - 76), (double)(y - this.offset - 4), (double)(this.width - 52), (double)(y - this.offset + 20), 1.0D, Colors.getColor(80, 255), hovering ? -1 : Colors.getColor(20, 255));
   ...
   public void initGui() {
      ...
      this.buttonList.add(new GuiButton(0, this.width / 2 + 105, 5, 100, 20, "Multiplayer"));
