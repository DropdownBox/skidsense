    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
            	...
            	RenderUtil.drawGradientRect(this.xPosition, this.yPosition + 3, this.xPosition + this.width, (this.yPosition + this.height) - 3, new Color(35, 35, 35).getRGB(), new Color(27, 27, 27).getRGB());
            }
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawStringWithShadow("§o" + s1, (float)l, (float)i1, i);
            }
