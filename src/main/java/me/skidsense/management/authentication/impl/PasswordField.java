package me.skidsense.management.authentication.impl;
...
public class PasswordField extends Gui {
   ...
   private int enabledColor = new Color(149,184,6).getRGB();
      ...
      if (this.func_73778_q()) {
         if (this.getEnableBackgroundDrawing()) {
            //Gui.drawRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1, -6250336);
        	 RenderUtil.drawGradientRect(this.xPos, this.yPos + 3, this.xPos + this.width, (this.yPos + this.height) - 3, new Color(35, 35, 35).getRGB(), new Color(27, 27, 27).getRGB());
         }
         ...
         if (var4.length() > 0) {
            ...
            var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("§o" + this.text.replaceAll("(?s).", "*"), (float)var7, (float)var8, var1);
         }
         ...
         if (var6) {
            if (var10) {
               ...
               Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("|", (float)var11, (float)var8, var1);
            }
         }
