...
extends ValueButton {
    ...
    public void render(int mouseX, int mouseY) {
        double d2 = mouseX > this.x - 7 && mouseX < this.x + 85 && mouseY > this.y - 6 && mouseY < this.y + ((UnicodeFontRenderer) Client.fontManager.sansation18).getStringHeight(this.cheat.getName()) + 5 ? (this.opacity + 10.0 < 200.0 ? (this.opacity = this.opacity + 10.0) : 200.0) : (this.opacity - 6.0 > 0.0 ? (this.opacity = this.opacity - 6.0) : 0.0);
        this.opacity = d2;
        UnicodeFontRenderer font = (UnicodeFontRenderer) Client.fontManager.sansation14;
    ...
    public void click(int mouseX, int mouseY, int button) {
        if (mouseX > this.x - 7 && mouseX < this.x + 85 && mouseY > this.y - 6 && mouseY < this.y + ((UnicodeFontRenderer) Client.fontManager.sansation18).getStringHeight(this.cheat.getName()) + 5 && button == 0) {
            this.bind = !this.bind;
