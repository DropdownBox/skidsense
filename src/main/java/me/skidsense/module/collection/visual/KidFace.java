...
extends Module {
    ...
    public void onRender(EventRender3D event) {
        for (EntityPlayer entity : this.mc.theWorld.playerEntities) {
            ...
            double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * (double)partialTicks - Minecraft.getMinecraft().getRenderManager().renderPosX;
            this.mc.getRenderManager();
            double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * (double)partialTicks - Minecraft.getMinecraft().getRenderManager().renderPosY;
            this.mc.getRenderManager();
            double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * (double)partialTicks - Minecraft.getMinecraft().getRenderManager().renderPosZ;
            float SCALE = 0.035f;
