        ...
        try {
            ...
            new Thread(() -> {
                try {
                    ...
                    this.failReason = e;
                    this.failed = true;
                    if (Client.mc.currentScreen != null && Client.mc.currentScreen instanceof GuiConnecting && ((GuiConnecting)Client.mc.currentScreen).networkManager != null) {
                        ((GuiConnecting)Client.mc.currentScreen).networkManager.closeChannel(new ChatComponentText("Proxy failure"));
                    }
                    try {
                        this.client.close();
                    }
