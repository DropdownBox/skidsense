...
public class CustomTextF extends Gui {
	...
	/**
	 * delete the selected text, otherwise deletes characters from either side of
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			int i = this.isEnabled ? Color.BLACK.getRGB() : this.disabledColor;
			...
			if (k != j) {
				...
				RenderUtil.drawRect(k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, Color.GRAY.getRGB());
