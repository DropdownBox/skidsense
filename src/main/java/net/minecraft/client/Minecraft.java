...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("skidsense/launching.png");
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("skidsense/icon_16x16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("skidsense/icon_32x32.png"));
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) {
        ...
        try
        {
            ...
            textureManagerInstance.bindTexture(this.locationMojangPng);
        }
        catch (IOException ioexception)
        {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
