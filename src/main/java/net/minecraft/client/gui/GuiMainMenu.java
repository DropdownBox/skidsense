...
public void initGui() {
   ...
   private void drawSkeetBox2() {
	      ...
	      //rainbow条
	      RenderUtil.drawGradientSideways((double)(sr.getScaledWidth() / 2 - 52 + 3), (double)(this.height / 4 + 20 + 3), (double)(sr.getScaledWidth() / 2), (double)(this.height / 4 + 20 + 4), Colors.getColor(55, 177, 218), Colors.getColor(204, 77, 198));
	      RenderUtil.drawGradientSideways((double)(sr.getScaledWidth() / 2), (double)(this.height / 4 + 20 + 3), (double)(sr.getScaledWidth() / 2 + 52 - 3), (double)(this.height / 4 + 20 + 4), Colors.getColor(204, 77, 198), Colors.getColor(204, 227, 53));
	      
	      RenderUtil.rectangle((double)(sr.getScaledWidth() / 2 - 52 + 3), (double)(this.height / 4 + 20) + 3.5D, (double)(sr.getScaledWidth() / 2 + 52 - 3), (double)(this.height / 4 + 20 + 4), Colors.getColor(0, 110));
	      RenderUtil.rectangleBordered((double)(sr.getScaledWidth() / 2 - 52 + 6), (double)(this.height / 4 + 20 + 8), (double)(sr.getScaledWidth() / 2 + 52) - 6.5D, (double)(this.height / 4 + 159), 0.3D, Colors.getColor(48), Colors.getColor(10));
	      RenderUtil.rectangle((double)(sr.getScaledWidth() / 2 - 52 + 6 + 1), (double)(this.height / 4 + 20 + 9), (double)(sr.getScaledWidth() / 2 + 52) - 7.5D, (double)(this.height / 4 + 159 - 1), Colors.getColor(17));
	      RenderUtil.rectangle((double)((float)(sr.getScaledWidth() / 2 - 52 + 6) + 4.5F), (double)(this.height / 4 + 20 + 8), (double)(sr.getScaledWidth() / 2 - 52 + 35), (double)(this.height / 4 + 20 + 9), Colors.getColor(17));
   ...
   private void drawSkeetBox() {
	      ...
	      //rainbow条
	      RenderUtil.drawGradientSideways((double)(sr.getScaledWidth() / 2 - 62 + 3), (double)(this.height / 4 + 30 + 3), (double)(sr.getScaledWidth() / 2), (double)(this.height / 4 + 30 + 4), Colors.getColor(55, 177, 218), Colors.getColor(204, 77, 198));
	      RenderUtil.drawGradientSideways((double)(sr.getScaledWidth() / 2), (double)(this.height / 4 + 30 + 3), (double)(sr.getScaledWidth() / 2 + 62 - 3), (double)(this.height / 4 + 30 + 4), Colors.getColor(204, 77, 198), Colors.getColor(204, 227, 53));
	      
	      RenderUtil.rectangle((double)(sr.getScaledWidth() / 2 - 62 + 3), (double)(this.height / 4 + 30) + 3.5D, (double)(sr.getScaledWidth() / 2 + 62 - 3), (double)(this.height / 4 + 30 + 4), Colors.getColor(0, 110));
	      RenderUtil.rectangleBordered((double)(sr.getScaledWidth() / 2 - 62 + 6), (double)(this.height / 4 + 30 + 8), (double)(sr.getScaledWidth() / 2 + 62) - 6.5D, (double)(this.height / 4 + 169), 0.3D, Colors.getColor(48), Colors.getColor(10));
	      RenderUtil.rectangle((double)(sr.getScaledWidth() / 2 - 62 + 6 + 1), (double)(this.height / 4 + 30 + 9), (double)(sr.getScaledWidth() / 2 + 62) - 7.5D, (double)(this.height / 4 + 169 - 1), Colors.getColor(17));
	      RenderUtil.rectangle((double)((float)(sr.getScaledWidth() / 2 - 62 + 6) + 4.5F), (double)(this.height / 4 + 30 + 8), (double)(sr.getScaledWidth() / 2 - 62 + 35), (double)(this.height / 4 + 30 + 9), Colors.getColor(17));
