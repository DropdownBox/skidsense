...
import net.optifine.json.JSONArray;
import net.optifine.json.JSONObject;
import net.optifine.json.JSONParser;
import net.optifine.json.JSONWriter;
import net.optifine.json.ParseException;
...
public class Installer
{
    ...
    private static void updateJson(File dirMcVers, String mcVerOf, File dirMcLib, String mcVer, String ofEd) throws IOException, ParseException
    {
        ...
        if (!s1.startsWith("net.minecraft.launchwrapper."))
        {
            ...
            if (s2 != null)
            {
                s2 = s2 + "  --tweakClass net.optifine.OptiFineTweaker";
            ...
            else
            {
                ...
                jsonarray1.add("net.optifine.OptiFineTweaker");
